...
public class GestureCropImageView extends CropImageView {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        // Parche Escuela Fútbol: no forzar wrap al soltar — igual que al soltar la rueda Escala,
        // devolvía el zoom al mínimo que cubre el recorte y el usuario no podía mantener un alejamiento menor.
        return true;
    }
